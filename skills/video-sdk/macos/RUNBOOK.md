# Video SDK macOS 5-Minute Preflight Runbook
...
- Confirm this is a Video SDK custom session flow for macOS (not Meeting SDK).
...
- https://developers.zoom.us/docs/video-sdk/macos/
- https://marketplacefront.zoom.us/sdk/custom/macos/annotated.html

### Raw docs in repo

- `tools/zoom-crawler/raw-docs/developers.zoom.us/docs/video-sdk/macos/`
