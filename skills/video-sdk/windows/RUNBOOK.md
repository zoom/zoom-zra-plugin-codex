# Video SDK Windows 5-Minute Preflight Runbook
...
- Confirm this is a Video SDK custom session flow for Windows (not Meeting SDK).
...
- https://marketplacefront.zoom.us/sdk/custom/windows/

### Raw docs in repo

- `raw-docs/developers.zoom.us/docs/video-sdk/windows/`
