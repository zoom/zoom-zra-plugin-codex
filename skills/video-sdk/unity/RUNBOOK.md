# Video SDK Unity 5-Minute Preflight Runbook
...
- Confirm this is a Video SDK custom session flow for Unity (not Meeting SDK).
...
- https://developers.zoom.us/docs/video-sdk/unity/
- https://marketplacefront.zoom.us/sdk/custom/unity/index.html

### Raw docs in repo

- `tools/zoom-crawler/raw-docs/developers.zoom.us/docs/video-sdk/unity/`
- `tools/zoom-crawler/raw-docs/marketplacefront.zoom.us/sdk/video-sdk/unity/`
